...
const SignInSide = () => {
  ...
  const handleSubmit = async () => {
    ...
    const response = await fetch(`/geneontology/testcontrol`, requestOptions);
      ...
      <AppBar color="default" variant="contained">
        <Toolbar>
          <Typography variant="h5">
            Gene set enrichment analysis for Cryptococcus neoformans var. grubii
          </Typography>
        </Toolbar>
      </AppBar>
          ...
          <Grid item xs={12} sm={8} md={6} component={Paper}>
            <div className={classes.paper}>
              <TextField
                ...
                inputProps={{
                  style: { fontFamily: "nunito", borderColor: "black" },
                }}
              ></TextField>
              <br></br>
              <br></br>
